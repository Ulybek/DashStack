...
const data = {
  ...
  total_objects: [
    ...
    { id: 2, label: "Total Order", number: "10,293", iconLight: "/images/totalorder-icon-white.png", iconDark: "/images/totalorder-icon-dark.png", pathImg: '/images/pathgrow.png', percent: '8.5%', action: 'Up from yesterday' },
    { id: 3, label: "Total Sales", number: "$89,000", iconLight: "/images/totalsales-icon-white.png", iconDark: "/images/totalsales-icon-dark.png", pathImg: '/images/pathgrow.png', percent: '4.3%', action: 'Down from yesterday' },
    { id: 4, label: "Total Pending", number: "2040", iconLight: "/images/totalpending-icon-white.png", iconDark: "/images/totalpending-icon-dark.png", pathImg: '/images/pathgrow.png', percent: '8.5%', action: 'Up from yesterday' }
  ],
  chart_data: [
    { name: '5k', value: 0.2 },
    { name: '10k', value: 0.45 },
