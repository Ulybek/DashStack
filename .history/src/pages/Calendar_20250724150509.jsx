...
export default function Calendar() {
    const [events, setEvents] = useState([
        {
            ...
            image: '/images/calendar-img-1.png',
            color: '#6C63FF'
        },
        {
            id: '2',
            ...
            image: '/images/calendar-img-2.png',
            color: '#FF6B6B'
        },
        {
            id: '3',
            ...
            image: '/images/calendar-img-3.png',
            color: '#FFB347'
        },
        {
            id: '4',
            ...
            participants: 42,
            avatars: ['/images/calendar-avatar-3.png'],
            image: '/images/calendar-img-4.png',
            color: '#2F80ED'
        }
    ]);
    ...
    const handleEventClick = (clickInfo) => {
        ...
        setAnchorEl(clickInfo.el); // ссылка на DOM-элемент события
    };
    ...
    useEffect(() => {
        if (anchorEl && popperRef.current) {
            popperInstance.current = createPopper(anchorEl, popperRef.current, {
                placement: 'auto', // автоматически выбирает место (top/bottom/left/right)
                modifiers: [
            ...
            <div className='calendar-wrapper'>
                ...
                <div className='calendar-section calendar'>
                    <FullCalendar
                        ...
                        selectable={true}
                        selectMirror={true}
                        dayMaxEvents={false} // убираем "+1 more"
                        events={events}
                        eventContent={(arg) => {
                            const color = arg.event.extendedProps.color || '#487fff';
                            ...
                            const textColor = darkenColor(color, 0.8);
                    ...
                    {selectedEvent && (
                        <div ref={popperRef} className="event-popup">
                            ...
                            <img src={selectedEvent.extendedProps.image} alt="Event" className="popup-image" />
                            <div className="popup-content">
                                <h4>{selectedEvent.title}</h4>
                                <p>{new Date(selectedEvent.start).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
