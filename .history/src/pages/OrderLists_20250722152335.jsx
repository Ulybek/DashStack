                ...
                <table className="filter-table">
                    <tbody>
                        <tr>
                            ...
                            {/* Date Filter */}
                            <td className="filter-cell">
                                <div onClick={() => setIsOpen(!isOpen)} className="date-trigger">
                                    <span>
                                ...
                                {isOpen && (
                                    <div className="datepicker-popup">
                                        ...
                                        />
                                        <p className="datepicker-hint">*Hold Shift (or long tap) to select multiple dates</p>
                            ...
                            <td className="filter-cell" ref={typeRef}>
                                ...
                                >
                                    <span>{filters.type || "Order Type"}</span>
                                    <img
                                ...
                                {isTypeOpen && (
                                    <div className="dropdown-menu">
                                        <div
                                            className={filters.type === "Online" ? "selected" : ""}
                                            onClick={() => handleTypeSelect("Online")}
                                        >
                                            Online
                                        </div>
                                        <div
                                            className={filters.type === "In-Store" ? "selected" : ""}
                                            onClick={() => handleTypeSelect("In-Store")}
                                        >
                                            In-Store
                                        </div>
                                    </div>
