...
export default function Calendar() {
    ...
    const handleAddEvent = () => {
        ...
        const newEventObj = {
            ...
            participants: 0,
            avatars: [],
            image: newEvent.imagePreview || '',
            color: newEvent.color
        };

        setEvents([...events, newEventObj]);
        setIsModalOpen(false);
        setNewEvent({ title: '', location: '', date: '', time: '', image: '', imageFile: null, imagePreview: '', color: '#4CAF50' });
    };
                    ...
                    <ul className="event-list">
                        {events.map((event, idx) => (
                            <React.Fragment key={event.id}>
                                ...
                                {idx < events.length - 1 && <li className="event-divider"></li>}
                            </React.Fragment>
                        ))}
                    </ul>
