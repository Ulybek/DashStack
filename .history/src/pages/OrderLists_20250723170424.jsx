                    ...
                    <tbody>
                        <tr>
                            <td className="filter-cell">
                                <img src={darkMode ? "/images/filter-icon-light.png" : "/images/filter-icon-dark.png"} alt="Filter" className="filter-icon" />
                            </td>
                            <td className="filter-cell">
                            ...
                            <td className="filter-cell" ref={dropdownRefs.status}>
                                <button className="dropdown-btn" onClick={() => toggleDropdown("status")}>
                                    {filters.status.length > 0
                                        ...
                                        : "Order Status"}
                                    <IoIosArrowDown
                                        className={`icon-dropdown ${openDropdown === "status" ? "open" : ""}`}
                                    />
                                </button>
                                {openDropdown === "status" && (
                            ...
                            <td className="filter-cell reset-cell">
                                <button className="reset-filter-button" onClick={resetFilters}>
                                    <img src={darkMode ? "/images/reset-icon-orange.png" : "/images/reset-icon-orange.png"} alt="Reset" className="icon-reset" />
                                    Reset Filter
                                </button>
                            </td>
                        </tr>
