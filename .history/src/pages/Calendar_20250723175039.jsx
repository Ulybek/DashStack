...
export default function Calendar() {
  const [events, setEvents] = useState([
    ...
    },
    {
      ...
      participants: 20,
      avatars: ['/images/calendar-avatar-1.png', '/images/calendar-avatar-2.png', '/images/calendar-avatar-3.png.png'],
      color: '#FF6B6B'
    },
    {
      id: '3',
      ...
      participants: 14,
      avatars: ['/images/calendar-avatar-2.png', '/avatars/a5.png'],
      color: '#FFB347'
    },
    {
      id: '4',
      ...
      participants: 42,
      avatars: ['/avatars/a6.png', '/avatars/a7.png', '/avatars/a8.png'],
      color: '#2F80ED'
    }
  ]);
