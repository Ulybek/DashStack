...
export default function OrdersTable() {
    ...
    const openCalendar = () => {
        if (flatpickrRef.current && flatpickrRef.current.flatpickr) {
            flatpickrRef.current.flatpickr.open(); // вручную открываем календарь
        }
    };
    ...
    const resetFilters = () => {
        ...
        if (flatpickrRef.current) flatpickrRef.current.flatpickr.clear(); // сбросить календарь
                        ...
                        <tr>
                            ...
                            <td className="filter-cell">
                                <div onClick={openCalendar} className="date-trigger">
                                    <span>{filters.date ? filters.date : "Date"}</span>
                                    <img
                                ...
                                {/* Скрытый Flatpickr (только календарь) */}
                                <Flatpickr
                                    ref={flatpickrRef}
                                    value={filters.date}
                                    options={{
                                    ...
                                    style={{ display: "none" }} // полностью скрываем
                                />
                            </td>
                            <td className="filter-cell">
