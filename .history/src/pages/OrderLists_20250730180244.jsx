...
export default function OrdersTable({ darkMode, setDarkMode }) {
    ...
    const [filteredData, setFilteredData] = useState(() => Array.isArray(data.order_data) ? [...data.order_data] : []);    // Данные после фильтрации
    ...
    useEffect(() => {
        const configs = [
            { key: "date", button: dateButtonRef, popup: datePopupRef, instance: datePopper },
            { key: "type", button: typeButtonRef, popup: typePopupRef, instance: typePopper },
            { key: "status", button: statusButtonRef, popup: statusPopupRef, instance: statusPopper },
        ];

        configs.forEach(({ key, button, popup, instance }) => {
            if (openDropdown === key && button.current && popup.current) {
                instance.current = createPopper(button.current, popup.current, {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="filter-cell" ref={dropdownRefs.date}>
                                ...
                                {openDropdown === "date" && (
                                    <div ref={datePopupRef} className="datepicker-popup">
                                        <DatePicker
                                            inline
                            ...
                            <td className="filter-cell">
                                ...
                                {openDropdown === "type" && (
                                    <div ref={typePopupRef} className="type-popup">
                                        ...
                                        <div className="popup-hint">*You can choose multiple Order types</div>
                            ...
                            <td className="filter-cell">
                                ...
                                {openDropdown === "status" && (
                                    <div ref={statusPopupRef} className="status-popup">
                                        ...
                                        <div className="popup-hint">*You can choose multiple Order Status</div>
                                        <button className="apply-btn" onClick={applyFilter}>Apply Now</button>
                                    </div>
                                )}
                            </td>
