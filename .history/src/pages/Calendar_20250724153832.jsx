...
export default function Calendar() {
    ...
    useEffect(() => {
        const handleClickOutside = (e) => {
            // Закрываем, если клик не по попапу
        ...
        // И на сам элемент события (anchorEl)
        if (anchorEl) {
            anchorEl.addEventListener('mousedown', handleClosePopup);
        }

        return () => {
            document.removeEventListener('mousedown', handleClickOutside);
            if (anchorEl) {
                anchorEl.removeEventListener('mousedown', handleClosePopup);
            }
        };
    }, [anchorEl]);
