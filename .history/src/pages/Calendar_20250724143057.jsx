                ...
                <div className='calendar-section calendar'>
                    <FullCalendar
                        ...
                        eventContent={(arg) => {
                            ...
                            // Делаем фон полупрозрачным (20%)
                            const bgColor = `${color}33`; // HEX + прозрачность (33 ≈ 20%)

                            return (
                                <div
                                  className="custom-event-fc"
                                  style={{
                                    backgroundColor: bgColor + '33', // 33 = прозрачность (20%)
                                    borderLeft: `4px solid ${bgColor}`, // полоса сбоку
                                  }}
                                >
                                  {arg.event.title}
                                </div>
