                        ...
                        {data.product_stock.map((product, index) => (
                            <tr key={index} className="orders-table__row">
                                <td className="orders-table__cell">
                                    <img src={product.image} alt={product.name} style={{ width: '40px', height: '40px', borderRadius: '8px' }} />
                                </td>
                                ...
                                <td className="orders-table__cell">
                                    <div className='setting-box'>
                                        <button style={{
                                            ...
                                            <img className='setting-button' src="/images/pencil-write.png" alt="edit" />
                                        </button>
                                        ...
                                        <button style={{
                                            ...
                                            <img className='setting-button' src="/images/bin.png" alt="delete" />
                                        </button>
                                    </div>
                                </td>
                            </tr>
