...
export default function Calendar() {
    ...
    const handleAddEvent = () => {
        ...
        const newEventObj = {
            ...
            participants: 1, // дефолтное значение
            avatars: ['/images/calendar-avatar-1.png'], // дефолтный аватар
            image: newEvent.imagePreview || '/images/calendar-event-image.png', // дефолтная картинка
            color: newEvent.color || '#4CAF50'
        };

        // Добавляем в начало, чтобы сразу появлялось в сайдбаре
