...
const data = {
  ...
  total_objects: [
    ...
    { id: 3, label: "Total Sales", number: "$89,000", iconLight: "/images/totalsales-icon-white.png", iconDark: "/images/totalsales-icon-dark.png", percent: '4.3%', action: 'Down from yesterday' },
